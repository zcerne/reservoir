...
BASE = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                    "data", "ladder", "canonical_lc_sinustest")
...
def build():
    d = {
        ...
        "reservoir": {
            ...
            "boundary_function": "sinus_random_2d", "boundary_scale": 15.0, "boundary_n_periods": 3, "boundary_phase_shift": 3.14159, "boundary_noise_level": 0.6,
